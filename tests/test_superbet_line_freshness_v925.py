...
def test_freshness_gate_loads_after_playable_ui_without_legacy_symphony_save_layer():
    ...
    assert "const freshness=()=>load('playable-freshness.js','tenis-ai-playable-freshness');" in text
    assert "load('playable-ui.js','tenis-ai-playable-ui',freshness)" in text
    assert "playable-line-freshness-v925.js" not in text
    assert "playable-ui-coherence-v917.js" not in text
