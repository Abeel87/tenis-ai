...
const checks=[
 ...
 ['Central app metadata is v8.0',meta.includes("appVersion: 'v8.0'")&&meta.includes("cacheVersion: 'v80'")],
 ['PWA registration is v80',app.includes("serviceWorker.register('sw.js?v=80')")],
 ['PWA cache is v80',/const CACHE\s*=\s*['"]tenis-ai-v80-[0-9a-z._-]+['"]/i.test(sw)],
