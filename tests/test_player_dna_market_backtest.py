...
def test_trajectory_validation_reports_rank_hits_without_promotion_claim():
                ...
                "trajectory": {
                    ...
                    "serve_order_conditioned": {
                        "p1_serves_first": {
                            ...
                            "scenario_families": [
                                {
                                    "family_id": "4:2|P1_DOMINANT|2:0",
                                    "probability": 0.18,
                                },
                                {
                                    "family_id": "3:3|P1_CONTROLLED|2:0",
                                    "probability": 0.14,
                                },
                            ],
                            "scenario_family_top16_mass": 0.72,
    ...
    families = metrics["scenario_family_conditioned_on_observed_first_server"]
    assert families["n"] == 1
    assert families["hit_at_1"] == 0.0
    assert families["hit_at_3"] == 1.0
    assert families["hit_at_8"] == 1.0
    assert families["hit_at_16"] == 1.0
    assert families["mean_top16_probability_mass"] == 0.72
    ...
    assert metrics["coverage"]["scenario_families"] == 1
