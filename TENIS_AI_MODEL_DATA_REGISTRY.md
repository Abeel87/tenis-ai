...
**Training archive budget change (2026-09-25, pending migration):** The canonical `training_archive_enforce_budget` and `training_archive_enforce_object_budget` remain the only write guards. Raise only their archive reservation cap from 250,000,000 to 300,000,000 B. Preserve the independent 750,000,000 B project accounted-storage ceiling, physical-plus-missing-reservation accounting, SHA dedupe, advisory lock, ACLs, latest-two manifest retention, pins and 168h grace. The Free organization has a 1 GB Storage quota; measured physical project objects were 561,343,745 B, including 249,998,501 B archive, before this change. This budget adjustment does not alter model/training, runtime-private, iNeed$ or automatic betting. Publish an inventory only after migration verification; continue GC audits naturally.
