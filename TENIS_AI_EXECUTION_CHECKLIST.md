...
1. Merge and deploy the bounded observer timeout migration from this PR, then verify a scheduled GC preview and apply audit. Do not delete before 2026-09-23T14:05:13.238755Z.\n2. Do not redo PR #476, the Supabase migration, Edge Function deployment, or the pre-grace manual GC; all are already proven complete.
