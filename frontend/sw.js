...
const CACHE='tenis-ai-mobile-presentation-stage2-20260911';
const CORE=['./','index.html','style.css','app.js','match-detail-data.js','account.js','presentation-data.js','player-avatars.js','manifest.webmanifest','favicon.png','brand-symbol.png'];
