...
const ASSETS=[
  ...
  'app.js','player-search.js','multi-model.js','account.js','community.js','community-fix.js','avatar-fix.js','community-hub.js','community-count-fix.js','early-hold-v7.js','supabase-config.js','manifest.webmanifest',
